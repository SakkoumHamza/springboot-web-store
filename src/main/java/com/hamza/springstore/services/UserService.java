...
//    public void login(String email, String password) { Used spring Authentication manager instead
//
//        if (!userRepository.existsByEmail(email))
//            throw new EmailAlreadyExistException();
//
//        var passwordRetrieved = userRepository.findByEmail(email).getPassword();
//
//        if (!passwordEncoder.matches(passwordRetrieved,password))
